      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {LINEUP_PRODUCTS.map((id) => {
            ...
            return (
              <div key={id} className="bg-[#0a1816] border border-[#132c28] rounded-2xl p-5 flex flex-col hover:border-[#1e443e] hover:shadow-[0_0_15px_rgba(16,185,129,0.1)] transition-all group">
                ...
                <div className="space-y-2 mt-auto">
                  {product.isComingSoon && (
                    <div className="inline-block px-2 py-1 rounded-full bg-slate-800 text-slate-300 text-[10px] font-bold">
                      출시 준비중
                    </div>
                  )}
                  <button 
