...
export default function Chatbot() {
  ...
  return createPortal((
    <div className="fixed bottom-[5rem] right-3 z-50 sm:right-6">
      ...
      {/* 챗봇 창 */}
      <div
        className={`${isOpen ? 'flex' : 'hidden'} absolute bottom-0 right-0 flex-col w-[350px] max-w-[calc(100vw-24px)] sm:w-[400px] sm:max-w-[400px] h-[550px] max-h-[80vh] bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden transition-all duration-300 origin-bottom-right`}
      >
        {/* 헤더 */}
