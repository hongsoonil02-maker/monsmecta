export const LABEL_DATA = {
  ...
  skincare: {
    ...
    ingredients: [
      ...
      { title: "2) 락토바실러스 람노서스 & 파라카제이", desc: "[면역 정상화] 피부 특화 유산균으로 무너진 장벽 튼튼하게 복구", note: "특화 균주" },
      { title: "3) 퀘르세틴 (Quercetin)", desc: "[가려움 차단] 천연 항히스타민제로 비만세포 히스타민 방출 억제", note: "40,000mg/L" },
      { title: "4) 브로멜라인 (Bromelain)", desc: "[흡수율 상승] 파인애플 추출 효소로 퀘르세틴 장 흡수율 비약적 상승 및 염증 완화", note: "30,000mg/L" },
      { title: "5) 오메가3 (Omega 3)", desc: "[장벽 복구] 무너진 피부 장벽(각질층)을 복구하는 천연 피부 재생 성분", note: "30,000mg/L" }
    ],
    reg_no: "제XX9UY0145호",
    type_val: "보조사료 / 미생물제 / 바실러스 서브틸리스 / 액상 / 반려동물용",
    amount_val: "바실러스 서브틸리스 1.0 x 10^7 CFU/g 이상, 부형제(정제수)",
