export const LABEL_DATA = {
  ...
  cancercare: {
    ...
    ingredients: [
      ...
      { title: "2) 베타글루칸(Beta-glucan)", desc: "면역 세포(NK세포 등) 강력 활성화" },
      { title: "3) 후코이단(Fucoidan)", desc: "비정상 세포 사멸 유도 및 종양 억제 보조" },
      { title: "4) 비타민 C", desc: "강력한 항산화 작용 및 활력 증진" },
      { title: "5) 커큐민(Curcumin)", desc: "전신 염증 반응 억제 및 통증 완화 보조" }
    ],
    reg_no: "제XX9UY0145호",
    type_val: "보조사료 / 미생물제 / 바실러스 서브틸리스 / 액상 / 반려동물용",
    amount_val: "바실러스 서브틸리스 1.0 x 10^7 CFU/g 이상, 부형제(정제수)",
    ingredients_list_val: "바실러스 서브틸리스, 비타민A, 아세트산나트륨, 프로피온산나트륨, 포도당, 정제수",
    effects: [
      "강력한 면역 세포 활성화 및 방어력 증진",
      "종양 억제 보조 및 항암 치료 부작용 완화",
      "전신 염증 반응 감소 및 활력 회복"
    ],
    weight_val: "30ml",
    mfg_val: "제조일자 별도 표기",
