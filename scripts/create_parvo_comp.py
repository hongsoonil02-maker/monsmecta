...
comp_path = r'c:\Users\master\parvogel_landing\src\components\ParvogelClinicalDocumentary.jsx'

jsx_content = '''import React, { useState, useRef } from 'react';
...
print('ParvogelClinicalDocumentary.jsx created successfully!')
