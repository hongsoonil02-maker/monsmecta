...
const logEntry = `\n- **[${now}] [monsmecta_landing]**: 긴급 가격 수정(몬스멕타 100ml 7,700원, 헤파맥스 30ml 3,300원, 레날디톡스 7,700원, 나머지 8종 커밍순/가격미책정), 몬스멕타 유리나리 -> 레날디톡스 제품명 전역 변경 및 모바일 A4 알림판 탭 전환 및 Wi-Fi 인쇄(AirPrint) 연동 개선 완료.\n`;
