...
SCENES = [
    ...
    },
    {
        ...
        "sub_text": "입원 7일 차. 몬스멕타·헤파맥스 복합 처방 간 해독 후,\n환축은 기적처럼 건강을 되찾아 최종 [완치 퇴원]했습니다.",
...
def create_title_card_image(scene, out_png):
    ...
    draw.rounded_rectangle([(140, 340), (940, 420)], radius=40, fill=(0, 81, 59, 230), outline=(52, 211, 153, 200), width=3)
    create_text_image(draw, scene["badge"], (540, 360), font_tag, (209, 250, 229, 255), align="center")
    ...
    create_text_image(draw, scene["subtitle"], (540, 750), font_sub, (167, 243, 208, 255), align="center")
...
def create_chart_scene_image(scene, out_png):
    ...
    draw.rounded_rectangle([(80, 80), (1000, 160)], radius=40, fill=(0, 81, 59, 240), outline=(52, 211, 153, 220), width=3)
    create_text_image(draw, scene["badge"], (540, 100), font_badge, (209, 250, 229, 255), align="center")
...
def create_outro_card_image(scene, out_png):
    ...
    draw.rounded_rectangle([(100, 100), (980, 180)], radius=40, fill=(0, 81, 59, 240), outline=(52, 211, 153, 200), width=3)
    create_text_image(draw, scene["badge"], (540, 120), font_top, (209, 250, 229, 255), align="center")

    font_title = get_font(48, True)
    create_text_image(draw, "소아 자견 급성 장독소증\n3단계 치료 프로토콜", (540, 220), font_title, (255, 255, 255, 255), align="center")
