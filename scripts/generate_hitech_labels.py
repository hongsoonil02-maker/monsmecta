...
products = [
    ...
    },
    {
        ...
        "ingredients": [
            ...
            ("Beta-glucan (베타글루칸)", "15% (2,500)"),
            ("Allicin (알리신)", "10% (2,500)"),
            ("Sulforaphane (설포라판)", "10% (2,500)"),
            ("Curcumin (커큐민)", "5% (2,500)"),
            ("Catechin (카테킨)", "5% (2,500)"),
            ("AFNC (천연복합추출물)", "5% (2,500)")
        ]
    },
    {
        "id": "coldzero",
        ...
        "ingredients": [
            ("Montmorillonite (요독 흡착 핵심성분)", "고함량"),
            ("Ssanghwa Extract (쌍화 복합 추출물)", "50% (2,500)"),
            ("Quercetin (퀘르세틴)", "20% (2,500)"),
            ("Liriope (맥문동)", "15% (2,500)"),
            ("Ulmus (유근피)", "15% (2,500)")
        ]
    },
    {
