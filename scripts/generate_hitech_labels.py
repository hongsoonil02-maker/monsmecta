...
products = [
    ...
    },
    {
        ...
        "ingredients": [
            ...
            ("Beta-glucan (베타글루칸)", "15% (25,000)"),
            ("Allicin (알리신)", "10% (25,000)"),
            ("Sulforaphane (설포라판)", "10% (25,000)"),
            ("Curcumin (커큐민)", "5% (25,000)"),
            ("Catechin (카테킨)", "5% (25,000)"),
            ("AFNC (천연복합추출물)", "5% (25,000)")
        ]
    },
    {
        "id": "coldzero",
        ...
        "ingredients": [
            ("Montmorillonite (요독 흡착 핵심성분)", "고함량"),
            ("Ssanghwa Extract (쌍화 복합 추출물)", "50% (25,000)"),
            ("Quercetin (퀘르세틴)", "20% (25,000)"),
            ("Liriope (맥문동)", "15% (25,000)"),
            ("Ulmus (유근피)", "15% (25,000)")
        ]
    },
    {
