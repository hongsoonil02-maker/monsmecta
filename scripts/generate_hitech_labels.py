...
products = [
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 비타민A, 아세트산나트륨, 프로피온산나트륨, 포도당, 몬모릴로나이트, 타우린, D-소르비톨, L-라이신, L-메티오닌, 비타민B12, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 베타글루칸, 알리신, 설포라판, 커큐민, 카테킨, AFNC, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 퀘르세틴, 맥문동추출물, 유근피추출물, 쌍화복합추출물, 정제수",
        "ingredients": [
            ("Montmorillonite (요독 흡착 핵심성분)", "고함량"),
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 퀘르세틴, 브로멜라인, 오메가3, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "unit_desc": "1L 기준",
        "raw_materials": "바실러스 서브틸리스, 코큐텐(Q10), 산사나무 열매 추출물, L-카르니틴, 타우린, 오메가3, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "unit_desc": "1L 기준",
        "raw_materials": "바실러스 서브틸리스, MSM, 그린립 머슬 추출물, 보스웰리아, 콘드로이친, 오메가3, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 엔도 프로테아제, 알파 아밀라제, 라이페이스, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 비타민A, 아세트산나트륨, 프로피온산나트륨, 포도당, 몬모릴로나이트, 듀퐁 다니스코 특화 유산균(L. plantarum 등 18종), 프락토올리고당, 정제수",
        "ingredients": [
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 아세트산나트륨, 프로피온산나트륨, 포도당, 몬모릴로나이트, 비타민A, 비타민D3, 비타민E, 비타민B1, 비타민B2, 비타민C, 니코틴산아미드, 판토텐산 칼슘, 정제수",
        "ingredients": [
            ("Montmorillonite (몬모릴로나이트)", "고함량"),
            ("Monsmecta Original 베이스 배합", "핵심 원료"),
    ...
    },
    {
        ...
        "raw_materials": "바실러스 서브틸리스, 아세트산나트륨, 프로피온산나트륨, 포도당, 몬모릴로나이트, 비타민A, 비타민D3, 비타민E, L-메티오닌, L-아르기닌, 정제수",
        "ingredients": [
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4 border-t border-white/20 pt-4 font-bold">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="text-gray-300">제조일로부터 18개월</span>
                                    </div>
                                </div>
                            </div>
